...
w4 = 0; % fertility benefit
wsi = 0:0.0001:0.1;% survival benefit

FREQ_STRAT1 = zeros(numel(wsi),5);
FREQ_STRAT2 = zeros(numel(wsi),5);
...
plot(wsi,mean(FREQ_STRAT1,2)-mean(FREQ_STRAT1(1,:)))
xlabel('ws')
ylabel('freq')
hold on 
plot(wsi,mean(FREQ_STRAT2,2)-mean(FREQ_STRAT2(1,:)))
xlabel('ws')
ylabel('freq')
